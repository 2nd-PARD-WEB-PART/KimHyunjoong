  ...
  return (
    <Column>
      <InnerRow1>
        <PostsButton>
          <img
            src={process.env.PUBLIC_URL + "/Posts.svg"}
            alt="게시물 버튼 이미지"
            width="20vh"
          />{" "}
          <PostsDiv>게시물</PostsDiv>
        </PostsButton>
        <SavedButton>
          <img
            ...
            width="20vh"
          />{" "}
          <SavedDiv>저장됨</SavedDiv>
        </SavedButton>
        <TaggedButton>
          <img
            src={process.env.PUBLIC_URL + "/Tagged.svg"}
            alt="태그 버튼 이미지"
            width="20vh"
          />{" "}
          <TaggedDiv>태그됨</TaggedDiv>
        </TaggedButton>
      </InnerRow1>
